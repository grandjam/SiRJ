...
source("answerSJT_rsp.R") # Main model that creates a person and completes SJT -- person evaluates items based on similarity of responses
...
### (6) Save data
save(conds, file = paste("conds_compRsp_sitAbs",id,".RData",sep = ""))
save(condsDat, file = paste("condsDat_compRsp_sitAbs",id,".RData",sep = ""))
