...
source("answerSJT_rspCxt.R") # Main model that creates a person and completes SJT -- person evaluates items based on similarity of response interpretation
...
### (6) Save data
save(conds, file = paste("conds_compRspCxt_sitPres",id,".RData",sep = ""))
save(condsDat, file = paste("condsDat_compRspCxt_sitPres",id,".RData",sep = ""))
