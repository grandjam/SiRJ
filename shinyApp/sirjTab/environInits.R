# Function for computing probability distributions in the environment
sitProbDist = function(sitProb, brSitVar, numSpecSit) {
  out = rbeta(numSpecSit, (sitProb*brSitVar), (1-sitProb)*brSitVar)
  return(out)
}
...
####################################
envStr = function(sitProb1, sitProb2, sitProb3, brSitVar) {
  # Situation & trace definitions
  ...
  sitTypeProb <- c(sitProb1, sitProb2, sitProb3) # Prior probability of different situation types in the environment
  ...
  sitSpecProb = rbind(sitProb1, sitProb2, sitProb3)
  ...
  return(list("sitProb" = sitTypeProb,
              "brSitVar" = brSitVar,
              "mvLength" = mvLength,
              "numSitMv" = numSitMv,
              "numRspMv" = numRspMv,
              "numSitCxtMv" = numSitCxtMv,
              "numRspCxtMv" = numRspCxtMv,
              "numSitType" = numSitType, 
              "numSpecSit" = numSpecSit,
              "sitSpecProb" = sitSpecProb,
              "tLen" = tLen,
              "numExptLvls" = numExptLvls,
              "sitSpecProto" = sitSpecProto,
              "sitCxtExptLvls" = sitCxtExptLvls,
              "rspExptLvls" = rspExptLvls,
              "rspCxtExptLvls"= rspCxtExptLvls
              )
         )
}